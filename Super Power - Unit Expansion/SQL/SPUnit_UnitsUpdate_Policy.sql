...
--WHERE Type = 'UNIT_SPUE_WEIYANG' AND NOT EXISTS (SELECT * FROM BuildingClasses WHERE Type='BUILDINGCLASS_SPUE_WEIYANG_PALACE');
-- Trigger
UPDATE Units SET Cost = 60, HurryCostModifier = 33
WHERE Type = 'UNIT_SPUE_WEIYANG';
--  AND EXISTS (SELECT * FROM BuildingClasses WHERE Type='BUILDINGCLASS_SPUE_WEIYANG_PALACE');

-- CREATE TRIGGER SPUE_WEIYANG
-- AFTER INSERT ON BuildingClasses
-- WHEN NEW.Type ='BUILDINGCLASS_SPUE_WEIYANG_PALACE'
-- BEGIN
...
INSERT INTO Unit_BuildingClassRequireds 	
		(UnitType, 				 BuildingClassType)
VALUES	('UNIT_SPUE_WEIYANG', 	'BUILDINGCLASS_SPUE_WEIYANG_PALACE');
...
INSERT INTO Units 	
		(Type, 						Class, 							PrereqTech, 				PolicyType,			RangedCombat,	Combat,	Range, ExtraMaintenanceCost,	Special, Cost, FaithCost,  HurryCostModifier, RequiresFaithPurchaseEnabled, Moves,   CombatClass, Domain, DefaultUnitAI, Description,						Civilopedia,						Strategy,	Help,									Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, ObsoleteTech, XPValueAttack, XPValueDefense, GoodyHutUpgradeUnitClass, UnitArtInfo, 					UnitFlagIconOffset, UnitFlagAtlas,			PortraitIndex, 	IconAtlas,			NoMinorGifts)
SELECT	'UNIT_SPUE_KNIGHT_NEW', 	'UNITCLASS_SPUE_KNIGHT_NEW',	'TECH_HORSEBACK_RIDING', 	'POLICY_LIBERTY',	RangedCombat,	Combat,	Range, ExtraMaintenanceCost,	Special, Cost, FaithCost,  HurryCostModifier, RequiresFaithPurchaseEnabled, Moves,   CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_SPUE_KNIGHT_NEW',	'TXT_KEY_CIV5_SPUE_KNIGHT_NEW_TEXT', 	Strategy, 	'TXT_KEY_UNIT_SPUE_KNIGHT_NEW_HELP', 	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, ObsoleteTech, XPValueAttack, XPValueDefense, GoodyHutUpgradeUnitClass, 'ART_DEF_UNIT_SPUE_KNIGHT_NEW',	0,					'SPUE_KNKN_FLAG_ATLAS',	32,				'SPUE_UNITS_ATLAS',	1
...
WHERE Type = 'UNIT_SPUE_GONDORGUARD';
--  AND EXISTS (SELECT * FROM BuildingClasses WHERE Type='BUILDINGCLASS_SPUE_TIRITH');

-- CREATE TRIGGER SPUE_GONDORGUARD
-- AFTER INSERT ON BuildingClasses
-- WHEN NEW.Type ='BUILDINGCLASS_SPUE_TIRITH'
-- BEGIN
...
INSERT INTO Unit_BuildingClassRequireds 	
		(UnitType, 				 	BuildingClassType)
VALUES	('UNIT_SPUE_GONDORGUARD', 	'BUILDINGCLASS_SPUE_TIRITH');
...
WHERE Type = 'UNIT_SPUE_ROHAN_CAVALRY';
--  AND EXISTS (SELECT * FROM BuildingClasses WHERE Type='BUILDINGCLASS_SPUE_GOLDEN_MEDUSELD');
-- -- Trigger
-- CREATE TRIGGER SPUE_ROHAN_CAVALRY
-- AFTER INSERT ON BuildingClasses
-- WHEN NEW.Type = 'BUILDINGCLASS_SPUE_GOLDEN_MEDUSELD'
-- BEGIN
...
INSERT INTO Unit_BuildingClassRequireds 	
		(UnitType, 				 		BuildingClassType)
VALUES	('UNIT_SPUE_ROHAN_CAVALRY', 	'BUILDINGCLASS_SPUE_GOLDEN_MEDUSELD');
...
VALUES	('UNIT_SPUE_HOT_AIR_BALLOON', 	'PROMOTION_HELI_ATTACK'),
		('UNIT_SPUE_HOT_AIR_BALLOON', 	'PROMOTION_IGNORE_TERRAIN_COST'),
...
INSERT INTO UnitClasses
		(Type,							Description,					DefaultUnit,			MaxPlayerInstances)
VALUES	('UNITCLASS_SPUE_TABOR',		'TXT_KEY_UNIT_SPUE_TABOR',		'UNIT_SPUE_TABOR',		5);

INSERT INTO Units 	
		(Type, 					Class, 						PrereqTech, PolicyType,				RangedCombat, Combat, Range, ExtraMaintenanceCost,	Special, Cost, 		FaithCost,  HurryCostModifier, PurchaseOnly,	RequiresFaithPurchaseEnabled, Moves,   MoveAfterPurchase,	CombatClass, Domain, DefaultUnitAI, Description,				Civilopedia,						Strategy,	Help,								Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, ObsoleteTech, 		XPValueAttack, XPValueDefense, GoodyHutUpgradeUnitClass, UnitArtInfo, 				UnitFlagIconOffset, UnitFlagAtlas,					PortraitIndex, 	IconAtlas,				NoMinorGifts)
SELECT	'UNIT_SPUE_TABOR', 		'UNITCLASS_SPUE_TABOR', 	PrereqTech, 'POLICY_SPUE_TABOR',	RangedCombat, Combat, 2, 	   ExtraMaintenanceCost,	Special, Cost/2, 	FaithCost,  1, 				   1, 				RequiresFaithPurchaseEnabled, Moves,   1,					CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_SPUE_TABOR',	'TXT_KEY_CIV5_SPUE_TABOR_TEXT', 	Strategy, 	'TXT_KEY_UNIT_SPUE_TABOR_HELP', 	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, 'TECH_BALLISTICS', 	XPValueAttack, XPValueDefense, 'UNITCLASS_ANTI_TANK_GUN','ART_DEF_UNIT_SPUE_TABOR',	0,					'SPUE_WARWARGON_FLAG_ATLAS',	35,				'SPUE02_UNITS_ATLAS',	1
FROM Units WHERE Type = 'UNIT_GERMAN_LANDSKNECHT';

INSERT INTO Unit_ClassUpgrades 	
		(UnitType, 			UnitClassType)
VALUES	('UNIT_SPUE_TABOR',	'UNITCLASS_ANTI_TANK_GUN');
...
INSERT INTO Unit_BuildingClassRequireds 	
		(UnitType, 				BuildingClassType)
SELECT	'UNIT_SPUE_TABOR',		BuildingClassType
FROM Unit_BuildingClassRequireds WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';

INSERT INTO UnitGameplay2DScripts 	
		(UnitType, 				SelectionSound, FirstSelectionSound)
SELECT	'UNIT_SPUE_TABOR',		SelectionSound, FirstSelectionSound
FROM UnitGameplay2DScripts WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';

INSERT INTO Unit_AITypes 	
		(UnitType, 				UnitAIType)
SELECT	'UNIT_SPUE_TABOR',		UnitAIType
FROM Unit_AITypes WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';

INSERT INTO Unit_Flavors 	
		(UnitType, 				FlavorType, Flavor)
SELECT	'UNIT_SPUE_TABOR',	   	FlavorType, Flavor
FROM Unit_Flavors WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';	

-- INSERT INTO Unit_ResourceQuantityRequirements 	
-- 		(UnitType, 				   ResourceType, Cost)
-- SELECT	'UNIT_SPUE_TABOR',	   ResourceType, Cost
-- FROM Unit_ResourceQuantityRequirements WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';
-- 胡斯车垒
INSERT INTO Units 	
		(Type, 						Class, 						PrereqTech, PolicyType,				RangedCombat,		Combat,		Range, ExtraMaintenanceCost,	Special, Cost, 	FaithCost,  HurryCostModifier, RequiresFaithPurchaseEnabled, Moves,   MoveAfterPurchase,	CombatClass, Domain, DefaultUnitAI, Description,						Civilopedia,							Strategy,	Help,									Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, ObsoleteTech, 		XPValueAttack, XPValueDefense, GoodyHutUpgradeUnitClass, 	UnitArtInfo, 				UnitFlagIconOffset, UnitFlagAtlas,				PortraitIndex, 	IconAtlas,				NoMinorGifts)
...
INSERT INTO Unit_ClassUpgrades 	
		(UnitType, 					UnitClassType)
VALUES	('UNIT_SPUE_TABOR_ELITE',	'UNITCLASS_ANTI_TANK_GUN');
...
INSERT INTO Unit_BuildingClassRequireds 	
		(UnitType, 						BuildingClassType)
SELECT	'UNIT_SPUE_TABOR_ELITE',		BuildingClassType
FROM Unit_BuildingClassRequireds WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';

INSERT INTO UnitGameplay2DScripts 	
		(UnitType, 						SelectionSound, FirstSelectionSound)
SELECT	'UNIT_SPUE_TABOR_ELITE',		SelectionSound, FirstSelectionSound
FROM UnitGameplay2DScripts WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';

INSERT INTO Unit_AITypes 	
		(UnitType, 						UnitAIType)
SELECT	'UNIT_SPUE_TABOR_ELITE',		UnitAIType
FROM Unit_AITypes WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';

INSERT INTO Unit_Flavors 	
		(UnitType, 				   		FlavorType, Flavor)
SELECT	'UNIT_SPUE_TABOR_ELITE',	    FlavorType, Flavor
FROM Unit_Flavors WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';	

INSERT INTO Unit_ResourceQuantityRequirements 	
		(UnitType, 				   		ResourceType, Cost)
SELECT	'UNIT_SPUE_TABOR_ELITE',	    ResourceType, Cost
FROM Unit_ResourceQuantityRequirements WHERE UnitType = 'UNIT_GERMAN_LANDSKNECHT';
--==========================================================================================================================	
-- 乌兰骑兵 -- 商业解锁
--==========================================================================================================================
...
INSERT INTO Unit_ClassUpgrades 	
		(UnitType, 				UnitClassType)
VALUES	('UNIT_SPUE_HESSIAN',	'UNITCLASS_GREAT_WAR_INFANTRY');
